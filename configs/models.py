...
class ConfigurationItem(models.Model):
    ...
    name = models.CharField(
        max_length=255, unique=True, help_text="Name of the Configuration Item"
    )
    ci_type = models.CharField(max_length=50, choices=CI_TYPE_CHOICES, default="server")
    description = models.TextField(blank=True)
    status = models.CharField(
        max_length=20, choices=CI_STATUS_CHOICES, default="active"
    )
    ...
    version = models.CharField(
        max_length=50,
        blank=True,
        help_text="Version of the CI (e.g., software version)",
    )
