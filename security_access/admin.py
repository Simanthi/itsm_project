...
from django.contrib.auth.models import User # Or your custom User model if you define it explicitly here
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'email', 'first_name', 'last_name', 'is_staff', 'is_it_staff_display')
