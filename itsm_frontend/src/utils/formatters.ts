...
export const formatDateString = (dateStr: string | null | undefined, format?: string): string => {
  if (!dateStr) return '';
  try {
...
export const formatCurrency = (amount: number | string | undefined | null, currencySymbol: string = '$'): string => {
