...
const headCells: readonly HeadCell[] = [
  ...
  { id: 'assigned_to_username', numeric: false, label: 'Assigned To', sortable: true }, // For sorting by user
  { id: 'location_name', numeric: false, label: 'Location', sortable: true }, // For sorting by location.name
  { id: 'purchase_date', numeric: false, label: 'Purchase Date', sortable: true },
...
const AssetList: React.FC = () => {
  ...
  const fetchAssets = useCallback(async () => {
    ...
    if (sortConfigKey) {
      ...
      else if (sortConfigKey === 'location_name') backendSortKey = 'location__name';
      else if (sortConfigKey === 'assigned_to_username') backendSortKey = 'assigned_to__username';
  ...
  }, [authenticatedFetch, page, rowsPerPage, searchTerm, statusFilter, categoryFilter, sortConfigKey, sortConfigDirection]);
  ...
  return (
    <Box sx={{ p: 1, width: '100%' }}>
              ...
              <TableRow key={asset.id} hover>
                ...
                <TableCell align="right">
                  ...
                  <Tooltip title="Delete Asset">
                    <IconButton onClick={() => handleOpenDeleteDialog(asset)} size="small">
                      <DeleteIcon />
                    </IconButton>
                  </Tooltip>
                </TableCell>
      ...
      <Dialog open={openDeleteDialog} onClose={handleCloseDeleteDialog}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete the asset: <strong>{selectedAssetForDelete?.asset_tag} - {selectedAssetForDelete?.name}</strong>?
          </Typography>
