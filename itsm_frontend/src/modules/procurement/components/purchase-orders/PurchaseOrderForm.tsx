...
const initialFormData: Partial<PurchaseOrderData> = {
  po_number: '', // Will be auto-generated by backend or shown when editing
...
const PurchaseOrderForm: React.FC = () => {
  ...
  useEffect(() => {
    if (poId) {
      ...
      // For new PO, po_number will be blank and read-only, assigned by backend.
      // No need to set a frontend-generated one anymore.
      // setFormData((prev) => ({
      //   ...prev,
      //   po_number: '', // Ensure it's blank for new forms
      // }));
    }
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <TextField
              name="po_number"
              label="PO ID"
              value={formData.po_number || (isEditMode ? '' : '[Auto-generated upon save]')}
              onChange={handleHeaderChange} // This won't be triggered due to readOnly/disabled
              fullWidth
              InputProps={{ readOnly: true }} // Always read-only
              disabled={true} // Always disabled
              helperText={!isEditMode && !formData.po_number ? "Assigned by system after creation" : ""}
            />
          </Grid>
          <Grid item xs={12} md={4}>
            <Autocomplete
