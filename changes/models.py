...
class ChangeRequest(models.Model):
    ...
    requested_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='submitted_changes')
    ...
    impact = models.CharField(max_length=20, choices=IMPACT_CHOICES, default='medium', help_text="Potential impact of the change")
    ...
    implementation_notes = models.TextField(blank=True, null=True, help_text="Notes from the change implementation")
    post_implementation_review = models.TextField(blank=True, null=True, help_text="Review of the change after completion")
