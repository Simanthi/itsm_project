...
class IncidentAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'status', 'priority', 'impact', 'reported_by', 'assigned_to', 'created_at', 'resolved_at')
    list_filter = ('status', 'priority', 'impact', 'urgency', 'created_at')
    search_fields = ('title', 'description', 'resolution_notes')
    raw_id_fields = ('reported_by', 'assigned_to', 'related_asset', 'related_ci') # Links to User, Asset, CI
