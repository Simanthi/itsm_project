...
class ApprovalRequest(models.Model):
    ...
    title = models.CharField(
        max_length=255, help_text="Summary of the item requiring approval"
    )
    ...
    initiated_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="initiated_approvals"
    )
...
class ApprovalStep(models.Model):
    ...
    approver = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="approval_steps"
    )
