...
class ServiceRequestSequence(models.Model):
    ...
    """
    current_alpha_part_char1 = models.CharField(max_length=1, default='A', help_text="First character of the alphanumeric part (e.g., 'A' for SR-AA-0001)")
    current_alpha_part_char2 = models.CharField(max_length=1, default='A', help_text="Second character of the alphanumeric part (e.g., 'A' for SR-AA-0001)")
    ...
    def get_next_sequence(cls):
        ...
        with transaction.atomic():
            ...
            seq_instance, created = cls.objects.select_for_update().get_or_create(pk=1, defaults={
            ...
            if next_numeric > 9999: # If it's 10000 or more, reset and carry over
                ...
                if next_char2_val >= 26: # 'Z' + 1
                    ...
                    if next_char1_val >= 26: # 'Z' + 1 for first char (exhausted ZZ-9999)
                        ...
                        raise ValueError("Service Request ID sequence exhausted (ZZ-9999 reached). Please implement a larger sequence or reset.")
            ...
            numeric_part = f"{seq_instance.current_numeric_part:04d}" # Pad with leading zeros
...
class ServiceRequest(models.Model):
    ...
    # New custom ID field
    request_id = models.CharField(max_length=15, unique=True, blank=True, help_text="Custom generated Service Request ID (e.g., SR-AA-0001)")
    ...
    resolution_notes = models.TextField(blank=True, null=True, help_text="Notes on how the request was fulfilled")
    ...
    def save(self, *args, **kwargs):
        if not self.request_id: # Only generate if request_id is not already set (for new instances)
